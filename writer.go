...
func (e *encoder) writeHeader() {
	...
	lePutUint16(e.buf[0:2], uint16(e.g.Config.Width))
	lePutUint16(e.buf[2:4], uint16(e.g.Config.Height))
	e.write(e.buf[:4])
	...
	if len(e.g.Image) > 1 && e.g.LoopCount >= 0 {
		...
		lePutUint16(e.buf[2:4], uint16(e.g.LoopCount))
...
func (e *encoder) writeImageBlock(pm *image.Paletted, delay int, disposal byte) {
	...
	if delay > 0 || disposal != 0 || transparentIndex != -1 {
		...
		lePutUint16(e.buf[4:6], uint16(delay)) // Delay Time (1/100ths of a second)
